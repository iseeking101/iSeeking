...
public class MyOldManAdpater extends BaseAdapter {
	Context context;
	List<MyOldManItem> items;
	...
	public MyOldManAdpater(Context context, List<MyOldManItem> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		MyOldManItem items = (MyOldManItem) getItem(position);
